  ...
  return (
    <section id="contact" className="py-24 lg:py-32 bg-dark text-white relative overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-6 lg:px-12 text-center">
        ...
        <AnimateIn delay={0.2}>
          <p className="mt-6 text-white/55 text-lg max-w-lg mx-auto leading-relaxed">
        ...
        <AnimateIn delay={0.3}>
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a
              ...
              className="inline-flex items-center gap-3 px-8 py-4 rounded-full border-2 border-white/20 text-white font-semibold text-base hover:border-accent hover:text-accent transition-all hover:-translate-y-1 w-full sm:w-auto justify-center"
            >
